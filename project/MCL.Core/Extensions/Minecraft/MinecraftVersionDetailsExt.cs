...
public static class MinecraftVersionDetailsExt
{
    public static bool LibrariesExists(this MinecraftVersionDetails versionDetails)
    {
        return versionDetails?.Libraries != null && versionDetails.Libraries?.Count > 0;
    }

    public static bool LoggingExists(this MinecraftVersionDetails versionDetails)
    {
    ...
    public static bool ClientMappingsExists(this MinecraftVersionDetails versionDetails)
    {
    ...
    public static bool ClientExists(this MinecraftVersionDetails versionDetails)
    {
    ...
    public static bool ServerMappingsExists(this MinecraftVersionDetails versionDetails)
    {
    ...
    public static bool ServerExists(this MinecraftVersionDetails versionDetails)
    {
    ...
    public static bool AssetIndexExists(this MinecraftVersionDetails versionDetails)
    {
