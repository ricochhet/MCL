...
public class ValidatedFileSystem : BaseFileSystem
{
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([path1, path2], NativeLogLevel.Fatal))
            return string.Empty;
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([path1, path2, path3], NativeLogLevel.Fatal))
            return string.Empty;
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([path1, path2, path3, path4], NativeLogLevel.Fatal))
            return string.Empty;
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace(paths, NativeLogLevel.Fatal))
            return string.Empty;
...
#pragma warning restore IDE0079, S2234
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([relativeTo, path], NativeLogLevel.Fatal))
            return string.Empty;
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([relativeTo], NativeLogLevel.Fatal))
            return string.Empty;
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([a, b], NativeLogLevel.Fatal))
            return;
        base.MoveFile(a, b);
    }
    ...
    {
        if (ObjectValidator<string>.IsNullOrWhiteSpace([filepath, data], NativeLogLevel.Fatal))
            return;
